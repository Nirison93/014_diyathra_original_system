...
const exportPdfUrl = computed(() =>
  route("reports.export.low-stock-store.pdf", {
    start_date: startDate.value,
    end_date: endDate.value,
  })
);
const exportCsvUrl = computed(() =>
  route("reports.export.low-stock-store.csv", {
    start_date: startDate.value,
    end_date: endDate.value,
  })
);
...
const exportPdf = async () => {
  await logActivity("create", "low_stock_store_report", {
    action: "export_pdf",
...
const filterReports = () => {
  ...
  router.get(route("reports.low-stock-store"), params, {
    preserveState: true,
    preserveScroll: true,
  });
};
